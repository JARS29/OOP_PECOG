...
expName = u'exemplo'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\JARS\\Documents\\psychopy_workshop\\Day_5\\exemplo.psyexp',
...
for thisTrial in trials:
    ...
    print (count_sent, order[index], index)
